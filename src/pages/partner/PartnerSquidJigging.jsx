    ...
    const activityTypes = [
        {
            id: '1_package',
            title: '1 Package',
            description: 'Register one main squid jigging package for your business.',
...
export default PartnerSquidJigging;
