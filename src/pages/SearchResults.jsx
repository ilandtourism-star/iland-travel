...
const SearchResults = () => {
    ...
    const allActivities = [
        // Kapas Island
        {
            ...
            rating: 4.0, reviews: 120, price: "49", image: imgRelax, link: "/kapas-snorkeling-details", buttonText: "View Details",
            features: [{ icon: "fas fa-ship", text: "BOAT TRANSFER" }, { icon: "fas fa-vest", text: "LIFE JACKET" }]
        },
        {
            title: "2. Mental Escape (Kapas)",
            rating: 4.5, reviews: 85, price: "59", image: imgMental, link: "/kapas-snorkeling-details", buttonText: "View Details",
            features: [{ icon: "fas fa-mask", text: "Snorkeling Gear" }, { icon: "fas fa-ship", text: "Boat Transfer" }]
        },
        {
            title: "3. Joy & Playfulness (Kapas)",
            rating: 5.0, reviews: 200, price: "69", image: imgJoy, link: "/kapas-snorkeling-details", badge: "TOP PICK", buttonText: "View Details",
            features: [{ icon: "fas fa-fish", text: "Marine Park Trip" }, { icon: "fas fa-vest", text: "LIFE JACKET" }]
        },
        {
            title: "4. Mood Booster (Kapas)",
            rating: 5.0, reviews: 150, price: "109", image: imgMood, link: "/kapas-snorkeling-details", buttonText: "View Details",
            features: [{ icon: "fas fa-hiking", text: "HIKING BUKIT SINGA" }]
        },
        {
            title: "5. Private Family Trip (Kapas)",
            rating: 4.5, reviews: 50, price: "850", image: imgPrivateTrip, link: "/kapas-private-boat-details", buttonText: "View Details",
            features: [{ icon: "fas fa-ship", text: "PRIVATE BOAT TRANSFER" }]
        },
        {
            title: "6. Exclusive Private Package (Kapas)",
            rating: 5.0, reviews: 40, price: "1300", image: imgExclusive, link: "/kapas-private-boat-details", badge: "PREMIUM", buttonText: "View Details",
            features: [{ icon: "fas fa-utensils", text: "FREE MEALS" }]
        },
        // Redang Island
        {
            title: "Day Trip Snorkeling (Redang)",
            rating: 4.8, reviews: 180, price: "100", image: "/images/Redang island/2.jpg", link: "/redang-snorkeling-details", badge: "BEST SELLER", buttonText: "View Details",
            features: [{ icon: "fas fa-mask", text: "Snorkeling Equipment" }, { icon: "fas fa-utensils", text: "Lunch Pack" }]
        },
        {
            title: "Squid Jigging (Redang)",
            rating: 4.5, reviews: 60, price: "1,350", image: "/images/Squid Jigging/1.png", link: "/redang-squid-jigging-details", buttonText: "View Details",
            features: [{ icon: "fas fa-moon", text: "Night Trip" }]
        },
        // Perhentian Island
        {
            title: "Day Trip Snorkeling (Perhentian)",
            rating: 4.8, reviews: 156, price: "100", image: "/images/perhentian island/1.png", link: "/perhentian-snorkeling-details", badge: "TOP PICK", buttonText: "View Details",
