...
const SnorkelingRedang = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const navigate = useNavigate();

  // Menggunakan ViewModel Hook
  const { vacations, loading, error } = useVacations('Redang', 'snorkeling');
  ...
  if (loading) {
    return <div style={{ textAlign: 'center', padding: '100px', fontSize: '18px', color: '#64748b' }}>Loading Redang Packages...</div>;
  }
  ...
  return (
    <main>
      ...
      <h1 className="page-title" style={{ textAlign: 'center', margin: '20px 0' }}>Redang Island Snorkeling Day Trip Details</h1>
        ...
        <div className="activities-grid" style={{
          ...
          {filteredVacations.map((pkg) => (
            <ActivityCard
              ...
              link={pkg.sku === 'snorkeling-redang' ? '/book/redang-snorkeling-day-trip' : '/redang-island-day-trips'}
...
export default SnorkelingRedang;
