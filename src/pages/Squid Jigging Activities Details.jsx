...
const SquidJigging = () => {
  ...
  return (
    <main>
      <div className="hero-section">
        <div className="search-container">
          <input
            ...
            placeholder="Live search activities..."
            value={searchQuery}
      ...
      <h1 className="page-title" style={{ textAlign: 'center', margin: '20px 0' }}>Squid Jigging Activities</h1>
        ...
        <div className="activities-grid" style={{
          ...
          {filteredPackages.map((pkg) => (
            <ActivityCard
              ...
              link={`/${pkg.name} Places (${pkg.island} Island)`}
